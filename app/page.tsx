  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--bg)", color: "var(--text)" }}>
      ...
      <main style={{ maxWidth: 900, margin: "0 auto", padding: "16px 16px 40px" }}>
        ...
        {/* ── Meet your mentor ── */}
        <h2 style={h2}>Meet Your Mentor</h2>
        <section
          style={{
            background: "var(--card)",
        ...
        >
          <img
            src="/nikki_maam.png"
            alt="Nikki Ma'am"
            style={{ width: 96, height: 96, borderRadius: "50%", objectFit: "cover", objectPosition: "top", border: `3px solid ${GOLD}`, background: "var(--chip)" }}
          />
          <div style={{ flex: 1, minWidth: 220 }}>
            <div style={{ fontWeight: 800, fontSize: 17 }}>Nikki Ma&apos;am</div>
            <div style={{ fontSize: 12.5, color: GOLD, fontWeight: 700, margin: "2px 0 6px" }}>English &amp; Exam Strategy Expert</div>
            <div style={{ fontSize: 13, color: "var(--muted)", lineHeight: 1.6 }}>
              Teaching English, vocabulary and exam strategy to government exam aspirants every day — free on YouTube. Every Selection Lab course carries her teaching style: simple, bilingual and exam-focused.
            </div>
            <a
              href="https://youtube.com/@selection_lab"
              target="_blank"
              style={{ display: "inline-block", marginTop: 10, background: "#ff0000", color: "#fff", borderRadius: 8, padding: "8px 16px", fontWeight: 800, fontSize: 12.5, textDecoration: "none" }}
            >
              ▶ Watch Free Classes
            </a>
          </div>
        ...
        {loading ? (
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(160px, 1fr))", gap: 12 }}>
            {featured.map((c: any) => (
              ...
              >
                <div style={{ height: 90, background: "var(--chip)", overflow: "hidden" }}>
