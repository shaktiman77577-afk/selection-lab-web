...
export default function ExcelPractice() {
  ...
  const hints: string[] = (q.hints_en?.length ? q.hints_en : q.hints_hi) || [];
  const instruction = q.instruction_en || q.instruction_hi;
  ...
  return (
    <Shell>
      ...
      {/* Hamesha dikhta hai. Pehle sirf type karte waqt dikhta tha — "Check"
          dabate hi focus hatta, ye line gaayab hoti aur button upar khisak
          jaata, to phone par pehla tap khaali jagah par padta tha. Student ko
          Check do baar dabana padta tha. Naye student ke liye ye ishara kaam
          ka bhi hai. */}
