...
export default function ExcelPractice() {
  ...
  if (error && !q) {
    return <Shell><p style={{ color: RED, fontSize: 14 }}>{error}</p></Shell>;
  }
  ...
  return (
    <Shell>
      <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 14 }}>
        <button onClick={() => router.push("/tier2/excel")} style={{ background: "none", border: "none", fontSize: 22, cursor: "pointer", color: "var(--text)", padding: 0 }}>←</button>
