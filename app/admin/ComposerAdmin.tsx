  ...
  return (
    <div>
      <div style={cardBox}>
        ...
        <label style={{ display: "flex", gap: 9, alignItems: "center", marginBottom: 14, fontSize: 13 }}>
          <input type="checkbox" checked={isFree} onChange={(e) => setIsFree(e.target.checked)} /> Free mock
        </label>
