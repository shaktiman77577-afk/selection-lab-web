...
function SeriesLevel(props: {
  ...
  function blank() {
    return { title: "", description: "", thumbnail_url: "", price: 0, original_price: 0, validity_days: 180, is_active: true, display_order: 0, bundle_ids: "", visible_on: "both", telegram_group: "" };
  }
      ...
      {showForm ? (
        <div style={{ ...cardBox, marginBottom: 16 }}>
          ...
          <ImageField
            ...
            reqW={1280}
            reqH={720}
            where="Descriptive list page ka card"
          />
