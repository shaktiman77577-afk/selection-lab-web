...
function MockTestsTab() {
  ...
  // Series form
  const [sForm, setSForm] = useState({ title: "", description: "", price: "0", original_price: "0", visible_on: "both" });
  ...
  async function createSeries() {
    ...
    try {
      ...
      setSForm({ title: "", description: "", price: "0", original_price: "0", visible_on: "both" });
