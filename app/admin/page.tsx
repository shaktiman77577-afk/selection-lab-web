...
type Tab = "home" | "health" | "seo" | "live" | "tickets" | "dashboard" | "courses" | "questions" | "qbank" | "mocktests" | "blog" | "banners" | "notifications" | "reviews" | "users" | "coupons" | "descriptive" | "appcontent" | "approvals" | "tier2" | "excel" | "search" | "email" | "partners" | "scorechecker" | "composer" | "extractor";
  ...
  async function upload() {
    ...
    try {
      for (let i = 0; i < total; i += CHUNK) {
        ...
        done += d.inserted || part.length;
      }
      setResult(`✓ ${done} questions upload ho gaye${chunks > 1 ? ` (${chunks} tukdon me)` : ""}`);
      setParsed([]);
      setCsvText("");
    } catch (e: any) {
      setError(
