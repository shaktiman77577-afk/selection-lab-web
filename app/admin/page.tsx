...
type Tab = "dashboard" | "courses" | "questions" | "reviews" | "users" | "coupons";
...
// Question, Option A, Option B, Option C, Option D, Answer (A/B/C/D), Explanation, Topic
    ...
    <div>
      <div style={{ background: CARD, border: `1px solid ${BORDER}`, borderRadius: 14, padding: 14, marginBottom: 14 }}>
        ...
        <p style={{ margin: "0 0 12px", fontSize: 12.5, color: "#9a917f", lineHeight: 1.6 }}>
          8 columns: Question, Option A, Option B, Option C, Option D, Answer (A/B/C/D), Explanation, Topic.
