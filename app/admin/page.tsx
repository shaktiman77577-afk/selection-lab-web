    ...
    return (
      <div style={{ background: CARD, border: `1px solid ${BORDER}`, borderRadius: 14, padding: 16 }}>
        ...
        <ImageField
          ...
          reqW={1280}
          reqH={720}
          where="Course card (website + app), aur agar 'Featured' tick hai to homepage ke hero carousel me bhi"
  ...
  return (
    <div>
      ...
      <div style={{ background: CARD, border: `1px solid ${BORDER}`, borderRadius: 14, padding: 14, marginBottom: 14 }}>
        ...
        <ImageField
          label="Series thumbnail (optional)"
          value={sForm.thumbnail_url || ""}
          onChange={(v) => setSForm({ ...sForm, thumbnail_url: v })}
          reqW={1280}
          reqH={720}
          where="Mock Tests list page ka card aur series detail page"
        />
        <div style={{ display: "flex", gap: 10 }}>
          <Field label="Price ₹" style={{ flex: 1 }}>
        ...
        <details style={{ marginBottom: 12 }}>
          ...
          <div style={{ background: "rgba(255,255,255,0.035)", borderRadius: 10, padding: 12, marginTop: 6 }}>
            {[
              ...
              ["Course thumbnail", "1280 × 720", "Course card; Featured ho to hero me bhi"],
              ["Mock series thumbnail", "1280 × 720", "Mock Tests list aur series page"],
              ["Descriptive thumbnail", "1280 × 720", "Descriptive list page ka card"],
            ].map(([what, size, place]) => (
