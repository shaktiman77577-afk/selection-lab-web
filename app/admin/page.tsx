...
type Tab = "home" | "health" | "seo" | "dashboard" | "courses" | "questions" | "qbank" | "mocktests" | "blog" | "banners" | "notifications" | "reviews" | "users" | "coupons" | "descriptive" | "appcontent";
      ...
      {tab === "home" ? (
        ...
        <div style={{ padding: "14px 16px 0", display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8, minWidth: 0 }}>
            <span style={{ fontSize: 18 }}>{activeAction?.icon || (tab === "health" ? "🩺" : tab === "seo" ? "📈" : "📊")}</span>
            <span
              style={{
            ...
            >
              {activeAction?.title || (tab === "health" ? "Troubleshooter" : tab === "seo" ? "SEO Coach" : "Aaj ki report")}
            </span>
          </div>
        </div>
      )}
