...
type Tab = "home" | "dashboard" | "courses" | "questions" | "qbank" | "mocktests" | "blog" | "banners" | "notifications" | "reviews" | "users" | "coupons" | "descriptive" | "appcontent";
...
const SECTION_INTRO: Record<string, string> = {
  home:
    "Namaste! Main Bullet hoon, aapka assistant. 🚀\nNeeche cards me se koi bhi kaam chun lijiye — har card ke neeche likha hai wo kya karta hai.\nKahin atak jaayein to yahan type karke pooch lijiye.\nDhyan rahe: jo bhi Save karenge wo turant users ko dikhne lagega.",
  dashboard:
    "Ye aaj ki report hai. 📊\nYahan sales, revenue aur naye users ka live data dikhta hai.\nRevenue kam lage to Coupons check kijiye — shayad koi bada discount chal raha ho.\nRoz subah ek baar yahan nazar daal lena achhi aadat hai.",
  courses:
    "Courses section — yahan se course banate aur badalte hain. 📚\nNaya course: title, price, thumbnail bharkar Save kijiye.\nPhir 'Content' button se uske andar video aur PDF daaliye — bina content ke course khaali dikhega.\n'Show on' se decide kijiye course App me dikhe, Website pe, ya dono pe.",
  mocktests:
    "Mock Tests do hisso me hai. 📝\nPehle Series banaiye (students yahi khareedte hain), phir uske andar test daaliye.\nTest ke liye CSV chahiye — Google Sheets se copy karke seedha paste kar dijiye, TAB apne aap chal jaata hai.\nPehle 2-3 test FREE rakhiye, demo dekhkar log poori series lete hain.",
  descriptive:
    "Descriptive writing ka section hai. ✍️\nTeen level hain: Series → Tests → Questions, upar se neeche banaiye.\nHar question me word limit, marks aur sample answer zaroor bhariye.\nSample answer isliye zaroori hai kyunki evaluation usi se hota hai.",
  questions:
    "Yahan se bulk me questions upload hote hain. ⬆️\nCSV format: 8 column = sirf English, 14 column = Hindi bhi, 15th column = Section ka naam.\nUpload se pehle 'Check CSV' zaroor dabaiye — galti wahin pakdi jaayegi.\nSheets se paste karenge to TAB apne aap detect ho jaata hai.",
  qbank:
    "Question Bank me saare purane questions hain. 🗂️\nYahan se search karke dekh sakte hain kya-kya upload ho chuka hai.\nDelete karne se question mock test me se bhi hat jaayega — dhyan rakhiyega.\nDuplicate check karne ke liye ye jagah sabse aasaan hai.",
  appcontent:
    "Ye sabse powerful section hai. 🎨\nYahan se App aur Website dono ka home content ek saath control hota hai.\nHero slides, faculty, exam countdown, testimonials aur announcement bar — sab yahin se.\nHar badlav ke baad 'Save all changes' dabana mat bhooliyega, warna kuch bhi live nahi hoga.",
  banners:
    "Banners app aur website ke carousel me dikhte hain. 🖼️\nImage pehle kisi host (jaise i.ibb.co) par upload kijiye, phir uska https link yahan paste kijiye.\nWide image rakhiye (lagbhag 1200x525), warna crop lag sakta hai.\nLink URL daalenge to banner tap karne par wahi page khulega.",
  blog:
    "Blog Google se free traffic laata hai. 📰\nHafte me 1-2 post kaafi hai, par regular honi chahiye.\nTitle me exam ka naam aur saal zaroor daaliye, jaise 'SSC CGL 2026 Syllabus'.\nHar post me apne course ya mock test ka link dena mat bhooliye.",
  users:
    "Users section — yahan har student ki poori kahani dikhti hai. 👥\nKisi naam par tap kijiye: kya kharida, kya sirf free try kiya, kitna kharch kiya — sab dikhega.\nUPI ya screenshot se payment aaya ho to 'Grant access' se manually unlock kar dijiye.\nJo log 'SIRF FREE' dikh rahe hain, unhe coupon bhejkar customer banaya ja sakta hai.",
  coupons:
    "Coupons se discount code bante hain. 🎟️\nScope zaroor chuniye — coupon sirf usi product par chalega jiske liye banaya hai.\nUsage report me dikhta hai kaunsa code kisne kab use kiya.\nGalat scope rakhne par student ko checkout par error milega, isliye ek baar khud test kar lijiye.",
  notifications:
    "Yahan se app users ke phone par push notification jaati hai. 🔔\nYe asli users tak turant pahunchti hai — bhejne se pehle typo zaroor check kar lijiye.\nMessage chhota aur saaf rakhiye, lamba message phone par kat jaata hai.\nTest ke liye faltu notification mat bhejiye, log app uninstall kar dete hain.",
  reviews:
    "Course reviews yahan dikhte hain. ⭐\nFake ya galat review turant hata sakte hain.\nAchhe reviews ko App Content ke Testimonials me daal dijiye — website par dikhenge.\nReviews naye students ka bharosa banate hain, inhe ignore mat kijiye.",
};

// Keyword se jawab — jitne zyada keyword match, wahi jawab
const BULLET_KB: { keys: string[]; a: string }[] = [
  { keys: ["csv", "format", "column", "columns"],
    a: "CSV ka format aisa hai:\n1-5: Question, A, B, C, D (English)\n6: Answer (sirf A/B/C/D likhiye)\n7-8: Explanation, Topic\nHindi bhi chahiye to 9-14 me wahi cheezein Hindi me, aur 15th column me Section ka naam. Sheets se copy karke paste kijiye — TAB apne aap chal jaata hai." },
  { keys: ["hindi", "bilingual", "dono bhasha", "hinglish question"],
    a: "Bilingual questions pehle se support hain.\nCSV me 8 ki jagah 14 column daaliye — 9 se 14 tak Question, A, B, C, D aur Explanation Hindi me.\nPhir app aur website par students ko हिंदी/English toggle milega.\nHindi na ho to wo cells khaali chhod dijiye, error nahi aayega." },
  { keys: ["course", "banao", "naya course", "course kaise"],
    a: "Naya course aise banaiye:\n1. Courses → Add course → title, description, price, thumbnail\n2. 'Show on' chuniye (App / Website / dono)\n3. Save karke 'Content' button se video aur PDF daaliye\nFeatured tick karenge to course home page par upar dikhega." },
  { keys: ["mock", "series", "test banana", "test kaise"],
    a: "Mock test banane ka tarika:\n1. Pehle Series banaiye — students series hi khareedte hain\n2. Test form me series chuniye, duration aur marks bhariye\n3. CSV paste karke 'Check CSV' → preview theek lage to Create\nPehle 2-3 test FREE rakhiye taaki log demo dekh sakein." },
  { keys: ["coupon", "discount", "code"],
    a: "Coupon banate waqt scope sabse zaroori hai.\n'All' rakhenge to har product par chalega, ya ek course/series chun lijiye.\nBanane ke baad khud checkout par ek baar laga kar dekh lijiye.\nUsage report me dikhega kaunsa code kisne kab use kiya." },
  { keys: ["grant", "access", "upi", "screenshot", "payment", "manually", "unlock"],
    a: "Manual payment aise handle kijiye:\n1. Users → student ka naam search karke kholiye\n2. 'Grant access' me chuniye: Course / Mock Series / Descriptive\n3. Item select karke Grant dabaiye\nStudent ko app ya website dobara kholne ko kahiye — access turant mil jaayega." },
  { keys: ["banner", "image", "thumbnail", "photo", "poster"],
    a: "Image ka link chahiye hota hai, file nahi.\nPehle i.ibb.co jaisi site par photo upload kijiye, phir uska https link copy karke yahan paste kijiye.\nBanner ke liye wide image achhi rehti hai (lagbhag 1200x525).\nPhone ki gallery ka path kaam nahi karega." },
  { keys: ["show on", "app only", "website only", "visible", "kahan dikhe", "platform"],
    a: "'Show on' se decide hota hai cheez kahan dikhegi:\nBoth = App aur Website dono par (default)\nApp only = sirf app me\nWebsite only = sirf website par\nDhyan rahe: jisne khareed liya hai uska access kabhi nahi jaata, ye sirf list me dikhna control karta hai." },
  { keys: ["delete", "hata", "remove", "wapas", "undo"],
    a: "Delete se pehle ye samajh lijiye:\nCourse ya series hide karne par jinhone khareeda hai unka access chalta rehta hai.\nQuestion delete karne par wo mock test me se bhi hat jaata hai.\nWapas laane ka koi button nahi hai, isliye doubt ho to pehle poochh lijiye." },
  { keys: ["notification", "push", "bhejo", "notify"],
    a: "Notification asli users ke phone par turant pahunchti hai.\nTitle chhota rakhiye aur message 2 line me — lamba text phone par kat jaata hai.\nBhejne se pehle spelling zaroor check kar lijiye, wapas nahi le sakte.\nHafte me 2-3 se zyada mat bhejiye, log app uninstall kar dete hain." },
  { keys: ["website pe nahi", "nahi dikh", "not showing", "gayab", "missing"],
    a: "Kuch website par nahi dikh raha? Ye teen cheezein check kijiye:\n1. Item active hai ya nahi\n2. 'Show on' me Website ya Both chuna hai ya nahi\n3. App Content me kuch badla ho to 'Save all changes' dabaya tha ya nahi\nPhir bhi na dikhe to page ek baar refresh kar lijiye." },
  { keys: ["descriptive", "essay", "letter", "precis"],
    a: "Descriptive me teen level hain: Series → Tests → Questions.\nPehle series banaiye (yahi bikti hai), phir uske andar test, phir test me question.\nHar question me type (Essay/Letter/Precis), word limit, marks aur sample answer bhariye.\nSample answer zaroori hai — evaluation usi ke aadhar par hota hai." },
  { keys: ["pdf", "watermark", "piracy", "leak"],
    a: "PDF par har student ka apna mobile number chhapta hai.\nIsse koi leak kare to pata chal jaata hai kisne kiya.\nPDF ka link seedha kabhi share mat kijiye, hamesha course ke andar se hi khulwaiye.\nLeak mile to Users tab se us account ko ban kar dijiye." },
  { keys: ["user", "student", "kaun", "activity", "kya kiya"],
    a: "Users tab me kisi naam par tap kijiye.\nUpar ek card batayega banda paying hai, sirf free try kar raha hai, ya bilkul inactive hai.\nNeeche uske saare mock attempts (FREE/PAID badge ke saath) aur descriptive answers dikhte hain.\n'SIRF FREE' wale log sabse achhe target hain — unhe coupon bhejiye." },
  { keys: ["blog", "seo", "google", "traffic"],
    a: "Blog se Google par free traffic aata hai.\nTitle me exam ka naam aur saal daaliye, jaise 'IB SA 2026 Syllabus'.\nPost ke andar apne course aur mock test ka link zaroor dijiye.\nHafte me 1-2 post regular daalte rahiye, 4-8 hafte me asar dikhta hai." },
  { keys: ["exam date", "countdown", "testimonial", "announcement", "hero", "slide"],
    a: "Ye sab App Content tab me hai.\nHero Slides se home ka carousel, Exam Dates se website par live countdown.\nTestimonials me selected students, aur Announcement Bar se website ke upar gold patti.\nHar badlav ke baad 'Save all changes' dabana zaroori hai." },
  { keys: ["price", "paisa", "kitna", "revenue", "sales"],
    a: "Sales aur revenue 'Aaj ki report' (Dashboard) me dikhta hai.\nPrice hamesha number me likhiye — sirf 499, 'Rs 499/-' nahi.\nOriginal price zyada rakhenge to students ko discount dikhta hai, isse sale badhti hai.\nKisne kya khareeda ye Users tab me har student ke andar dikhta hai." },
];

function bulletAnswer(q: string): string {
  const s = q.toLowerCase().trim();
  if (!s) return "";
  if (/^(hi|hello|hey|namaste|hii)\b/.test(s))
    return "Namaste! 🚀\nBataiye kya karna hai — course banana hai, mock test daalna hai, ya kisi student ko access dena hai?\nJo bhi poochhna ho seedha type kar dijiye.";
  ...
  return "Ye baat main theek se samajh nahi paaya. 🤔\nAap in me se kuch poochh sakte hain: 'course kaise banaye', 'CSV ka format', 'coupon', 'grant access', 'website par nahi dikh raha', 'Hindi question kaise daale'.\nYa seedha ek shabd likh dijiye — jaise 'banner' ya 'notification'.";
}
...
function BulletAvatar({ size = 54 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 64 64" aria-hidden>
      ...
      {/* fins */}
      <path d="M22 40 L15 50 L24 47 Z" fill={GOLD} opacity="0.85" />
      <path d="M42 40 L49 50 L40 47 Z" fill={GOLD} opacity="0.85" />
      {/* body */}
      <path d="M32 10 c8 7 11 17 11 26 c0 6 -3 11 -11 15 c-8 -4 -11 -9 -11 -15 c0 -9 3 -19 11 -26 Z" fill="#f4f0e6" stroke="#cfc7b4" />
      {/* nose */}
      <path d="M32 10 c4 3.5 6.5 8 8.3 13 h-16.6 c1.8 -5 4.3 -9.5 8.3 -13 Z" fill={GOLD} />
      {/* eyes */}
      <circle cx="27.8" cy="31" r="2.7" fill="#1a2f55" />
      <circle cx="36.2" cy="31" r="2.7" fill="#1a2f55" />
      <circle cx="28.7" cy="30.2" r="0.95" fill="#fff" />
      <circle cx="37.1" cy="30.2" r="0.95" fill="#fff" />
      {/* smile */}
      <path d="M28.2 35.6 q3.8 3 7.6 0" stroke="#1a2f55" strokeWidth="1.7" fill="none" strokeLinecap="round" />
      {/* flame */}
      <path d="M32 51 q3 5 0 8 q-3 -3 0 -8 Z" fill="#E8734A" />
    </svg>
  );
}
...
function Bullet({ section }: { section: string }) {
  ...
  // Section badalte hi uska intro chat me aa jaata hai
  useEffect(() => {
    const intro = SECTION_INTRO[section] || SECTION_INTRO.home;
  ...
  function send(text?: string) {
    ...
    setTyping(true);
    setTimeout(() => {
      setMsgs((m) => [...m, { from: "bot", text: bulletAnswer(q) }]);
      setTyping(false);
    }, 450);
  }

  const quick = ["CSV ka format", "Grant access", "Website par nahi dikh raha", "Hindi question"];
          ...
          {unread && (
            <span
              style={{
                ...
                borderRadius: "50%", background: "#E05555", border: "2px solid #0d0b08",
              }}
            />
          )}
        </button>
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "10px 12px", borderBottom: `1px solid ${BORDER}`, background: "#181510" }}>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <div style={{ fontSize: 10.5, color: "#5dd97c" }}>● Online · aapki madad ke liye</div>
            </div>
          ...
          <div style={{ display: "flex", gap: 6, overflowX: "auto", padding: "0 12px 8px" }}>
            {quick.map((qq) => (
              <button
                ...
                onClick={() => send(qq)}
                style={{
                  flexShrink: 0, fontSize: 11, padding: "5px 10px", borderRadius: 14, cursor: "pointer",
                  background: "transparent", color: "#c8c0ae", border: `1px solid ${BORDER}`,
                }}
              >
                {qq}
              </button>
      ...
      {tab === "home" ? (
        ...
        <div style={{ padding: "14px 16px 0", display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8, minWidth: 0 }}>
            <span style={{ fontSize: 18 }}>{activeAction?.icon || "📊"}</span>
            <span
              style={{
            ...
            >
              {activeAction?.title || "Aaj ki report"}
            </span>
          </div>
        </div>
      )}
...
function MockTestsTab() {
  ...
  // Series form
  const [sForm, setSForm] = useState({ title: "", description: "", price: "0", original_price: "0", visible_on: "both", thumbnail_url: "" });
  ...
  function cancelEditSeries() {
    setSEditId(null);
    setSForm({ title: "", description: "", price: "0", original_price: "0", visible_on: "both", thumbnail_url: "" });
  }
