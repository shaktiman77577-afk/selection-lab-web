...
type Tab = "home" | "health" | "seo" | "live" | "dashboard" | "courses" | "questions" | "qbank" | "mocktests" | "blog" | "banners" | "notifications" | "reviews" | "users" | "coupons" | "descriptive" | "appcontent";
      ...
      {tab === "home" ? (
        ...
        <div style={{ padding: "14px 16px 0", display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8, minWidth: 0 }}>
            <span style={{ fontSize: 18 }}>{activeAction?.icon || (tab === "health" ? "🩺" : tab === "seo" ? "📈" : tab === "live" ? "🟢" : "📊")}</span>
            <span
              style={{
            ...
            >
              {activeAction?.title || (tab === "health" ? "Troubleshooter" : tab === "seo" ? "SEO Coach" : tab === "live" ? "Live activity" : "Aaj ki report")}
            </span>
          </div>
        </div>
      )}
