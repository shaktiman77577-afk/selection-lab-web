        ...
        {!loading && tab === "worksheet" && (
          <>
            <div style={{ background: "var(--card)", border: "1px solid var(--line)", borderRadius: 12, padding: 13, marginBottom: 12, fontSize: 12.5, lineHeight: 1.75, color: "var(--muted)" }}>
              Isme sheet <b style={{ color: "var(--text)" }}>khud banani</b> hoti hai.
              Question paper PDF me milta hai — use print kijiye, saamne rakhiye,
              aur poori sheet type kijiye. Screen par sheet nahi dikhegi,
              bilkul asli exam ki tarah.
            </div>
            {worksheets.map((t) => (
              <div key={t.id} style={{ background: "var(--card)", border: "1px solid var(--line)", borderRadius: 12, padding: 13, marginBottom: 10, display: "flex", alignItems: "center", gap: 12 }}>
                <div style={{ width: 42, height: 42, borderRadius: 10, background: "var(--chip)", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 900, fontSize: 15, color: GOLD, flexShrink: 0 }}>
