            ...
            {!detail ? (
              ...
              <>
                ...
                {(detail.practice || []).map((p: Passage) => (
                  <PassageRow key={p.id} p={p} uid={uid} router={router} />
                ))}
                ...
                {(detail.tests || []).map((p: Passage) => (
                  <PassageRow key={p.id} p={p} uid={uid} router={router} isTest />
                ))}
...
// ── Ek passage ki row ───────────────────────────────────────────────────────
function PassageRow({ p, uid, router, isTest }: { p: Passage; uid?: number; router: any; isTest?: boolean }) {
  return (
    <div
      style={{
