      ...
      <div style={{ width: "100%", background: "var(--chip)", position: "relative", lineHeight: 0 }}>
        {(s.thumbnail_url || s.thumbnail_url_mobile) ? (
          <img
            ...
            style={{ width: "100%", height: "auto", maxHeight: 520, objectFit: "contain", display: "block" }}
          />
        ) : (
          <div style={{ display: "flex", alignItems: "center", justifyContent: "center", height: 140, fontSize: 34 }}>⌨️</div>
        )}
        <span
          style={{
