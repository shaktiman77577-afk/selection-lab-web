...
export default function SeriesDetailPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: BG, color: "#fff", paddingBottom: owned ? 20 : 90 }}>
      <header
        style={{
          position: "sticky",
          top: 0,
      ...
      <main style={{ maxWidth: 640, margin: "0 auto", padding: 16 }}>
        {loading && <p style={{ color: "#8d8371" }}>Loading...</p>}
        ...
        {series && (
          <>
            <div style={{ background: CARD, border: `1px solid ${BORDER}`, borderRadius: 16, padding: 16, marginBottom: 16 }}>
              ...
              {series.description && (
                <p style={{ margin: "8px 0 0", fontSize: 13.5, color: "#9a917f", lineHeight: 1.6 }}>{series.description}</p>
              )}
              <div style={{ display: "flex", gap: 14, marginTop: 12, fontSize: 13, color: "#cfc6b3" }}>
            ...
            {tests.map((t, i) => (
              <div
                ...
                style={{
                  ...
                  gap: 12,
                  background: CARD,
                  border: `1px solid ${t.is_unlocked ? BORDER : "rgba(255,255,255,0.08)"}`,
                  borderRadius: 14,
                  padding: 14,
                  marginBottom: 10,
              ...
              >
                <span
                  style={{
                    ...
                    fontSize: 14,
                    flexShrink: 0,
                    background: t.is_unlocked ? "rgba(255,171,0,0.15)" : "rgba(255,255,255,0.06)",
                    color: t.is_unlocked ? GOLD : "#8d8371",
                  }}
                >
                  {t.is_unlocked ? i + 1 : "🔒"}
                </span>
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <div style={{ fontSize: 12, color: "#9a917f", marginTop: 3 }}>
            ...
            {tests.length === 0 && !loading && (
              <p style={{ color: "#8d8371", textAlign: "center", padding: 20 }}>Tests will be added soon.</p>
            )}
          </>
        )}
      </main>
      ...
      {series && !owned && (
        ...
        >
          <div style={{ flex: 1 }}>
            ...
            <div style={{ fontSize: 11, color: "#9a917f" }}>Unlock all {tests.length} tests</div>
          </div>
          <button
            onClick={buySeries}
            disabled={paying}
