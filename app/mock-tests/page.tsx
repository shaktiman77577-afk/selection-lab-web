          ...
          >
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 10 }}>
              <div style={{ flex: 1 }}>
                ...
                {s.description && (
                  <p style={{ margin: "6px 0 0", fontSize: 13, color: "var(--muted)", lineHeight: 1.5 }}>{s.description}</p>
                )}
              </div>
              {s.is_purchased ? (
            ...
            <div style={{ display: "flex", gap: 14, marginTop: 12, fontSize: 12.5, color: "var(--text2)" }}>
