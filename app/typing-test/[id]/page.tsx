  ...
  useEffect(() => {
    ...
    fetch(`${API_URL}/tier2/typing/passage/${passageId}?user_id=${(u as any).id}`)
      .then(async (r) => {
        ...
        // SKAU/NTPC ka hisaab baaki modes se kaafi alag hai — 5% chhoot aur
        // har bachi galti par 10 shabd ki kaat. Jo student ise pehli baar
        // dekhta hai wo apna score samajh hi nahi paata. Isliye is mode me
        // pehle niyam dikhate hain, phir test.
        // Baaki modes ka flow bilkul pehle jaisa — chhua nahi gaya.
        if (d.scoring_mode === "ntpc") {
    ...
    <Shell>
      <div style={{ maxWidth: 720, margin: "0 auto" }}>
        ...
        <p style={{ fontSize: 12, color: "var(--muted)", marginTop: -6, marginBottom: 16 }}>
          ...
          <span style={{ color: GREY, fontWeight: 700 }}>Grey</span> = not reached.<br />Tap any red or blue word to see exactly what you typed.
        </p>
