 ...
 * Sabke liye free. Tasks lib/officeTasks.ts me hain.
 */
...
export default function OfficePracticeHome() {
  ...
  const card = (t: Task<any>, i: number) => (
    <button key={t.id} type="button" onClick={() => router.push(`/office-practice/${t.id}${qs}`)}
    ...
    <div style={{ maxWidth: 760, margin: "0 auto", padding: "14px 14px 40px", color: "var(--text)" }}>
      <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 12 }}>
        ...
        <div>
          ...
          <div style={{ fontSize: 12.5, color: "var(--muted)" }}>NBEMS Junior Assistant skill test pattern · free</div>
        </div>
      </div>
