  ...
  const paletteBody = (
    <>
      ...
      <button
        ...
        style={{ ...goldBtn, width: "100%", marginTop: 16 }}
      >
        Submit Test
      </button>
    </>
  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--bg)", color: "var(--text)", paddingBottom: 150 }}>
      ...
      >
        ...
        {!isLive && (
          <button
            ...
            style={{ ...ghostBtn, padding: "8px 12px", fontSize: 12.5 }}
          >
            ⏸ Pause
          </button>
        )}
      ...
      <div style={{ display: "flex", gap: 16, maxWidth: wide ? 1120 : 640, margin: "0 auto", padding: 14, alignItems: "flex-start" }}>
        <div style={{ flex: 1, minWidth: 0, background: "var(--card)", border: "1px solid var(--line)", borderRadius: 14, padding: 16 }}>
        ...
        {wide && (
          ...
          >
            <div style={{ fontWeight: 800, fontSize: 14.5, marginBottom: 10 }}>Question Palette</div>
            {paletteBody}
          </aside>
        )}
      </div>
