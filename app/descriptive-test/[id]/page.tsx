                    ...
                    {(!multi || active) ? (
                      <>
                        <textarea
                          ...
                          onKeyDown={(e) => {
                            // Tab band — warna focus box se bahar chala jata hai
                            // aur student ka likhna beech me ruk jata hai.
                            if (e.key === "Tab") {
                              e.preventDefault();
                              return;
                            }
                            // Ctrl+V / Ctrl+Shift+V se paste bhi band
                            // (onPaste kuch browsers me chhoot jata hai)
                            const k = e.key.toLowerCase();
                            if ((e.ctrlKey || e.metaKey) && (k === "v" || k === "insert")) {
                              e.preventDefault();
                            }
                            // Enter, Backspace, Caps Lock, arrow keys — sab
                            // normal chalte hain. Essay aur letter me paragraph
                            // ke liye Enter zaroori hai.
                          }}
                        ...
                        <div style={{ marginTop: 4, fontSize: 11, color: "var(--muted)" }}>
                          ✍️ Type your answer — press Enter for a new paragraph. Paste is disabled for a fair test.
                        </div>
                      </>
                    ) : hasDraft ? (
