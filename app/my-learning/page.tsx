  ...
  return (
    <div style={{ minHeight: "100vh", background: BG, color: "#fff" }}>
      ...
      <div style={{ padding: 16 }}>
        {loading && <p style={{ color: "#8d8371", fontSize: 14 }}>Loading your courses...</p>}

        {!loading && courses.length === 0 && (
          <div style={{ textAlign: "center", padding: "60px 20px" }}>
            <div style={{ fontSize: 44 }}>📚</div>
            <h2 style={{ fontSize: 18, fontWeight: 800, margin: "14px 0 6px" }}>No courses yet</h2>
            <p style={{ color: "#9a917f", fontSize: 14, margin: "0 0 20px" }}>
        ...
        {!loading && courses.length > 0 && (
          <p style={{ color: "#8d8371", fontSize: 13, textAlign: "center", marginTop: 18, lineHeight: 1.6 }}>
