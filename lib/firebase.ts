...
const firebaseConfig = {
  ...
  // CHANGED: use our OWN domain (proxied to firebaseapp.com via next.config.js
  // rewrites). This makes the signInWithRedirect handshake first-party, so
  // mobile browsers that block third-party storage no longer break login.
  authDomain: "selectionlab.in",
